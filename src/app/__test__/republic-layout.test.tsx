...
import RepublicLayout, { ErrorBoundary } from "../(republics)/[id]/_layout";
...
describe("republic layout", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  it("renderiza Stack com header oculto", () => {
    render(<RepublicLayout />);
  ...
  it("renderiza RouteErrorFallback com domain Republic", () => {
    const props = {
